...
<nav class="navbar navbar-inverse ">
  <div class="container-fluid">
    ...
    <a href="index" class="pull-left"></a>
     <div class="navbar-brand">Laptop</div>
    </div>
...
<div>
		...
		<form:form action="saveProduct" commandName="product" method="post"
			...
			<table style="width: 50%" align="center">
				...
				<tr>
					<td>
						<h3>Upload an image</h3></td><td>
						<input class="btn btn-success btn-lg" style="color:black" type="file" name="pimage"></td>
				</tr>
				<tr>
				<td> </td>
					<td> </td>
				...
				<tr>
				<td> </td>
					<td><input class="btn btn-success btn-lg"  style="color:black" type="submit" value="Submit"></td>
...
<table style="width:100%;text-color:white; border:4px solid gray;" border="4">
            <tr>
               <th>product image</th>
                <th>product id</th>
                <th> PRODUCT NAME</th>
